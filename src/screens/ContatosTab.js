...
import {buscarContatos, createChat} from "../actions/ChatActions";
...
export class ContatosTab extends React.Component{ //retirar o default, ele vai para o final, o redux é que será o default
    constructor(props) {
        ...
        console.log('construiu o ContatosTab.');
...
const ContatosTabConnect = connect(mapStateToProps, {buscarContatos, createChat})(ContatosTab); //conecta os dois componentes (suas props)
